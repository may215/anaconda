...
// sleepOrDone pauses the current goroutine until a signal is received on the
// done channel or until at least the duration d has elapsed, whichever comes
// first. This is similar to time.Sleep(d), except it can be interrupted.
